...
const Footer = () => {
    return (
        <footer className='bg-gray-900 text-white'>
            <div className='flex items-center justify-center sm:px-12 px-4 bg-[#ffffff19] py-7 md:justify-between'>
                <h1
                    className='text-center md:text-left lg:text-4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-semibold
        md:w-2/5'
                >
            ...
            <div className='flex flex-col md:flex-row justify-between mt-5 mb-12 px-4 lg:mx-[200px]'>
            ...
            <div className='flex flex-col md:flex-row justify-between mt-5 mb-12 px-4 lg:mx-[200px] md:justify-between'>
                <span className='flex justify-center items-center mb-2 sm:mb-2 md:mb-0 lg:mb-0'>
