  ...
  return (
    <header className="flex justify-between items-center py-4 px-10 bg-gray-900 text-white">
      ...
      <nav className="hidden md:flex md:items-center">
        <ul className="flex">
          <li className="px-10">
            <Link href="#" className="transition duration-300 ease-in-out hover:text-violet-400 text-2xl">Catálogo</Link>
          </li>
          <li className="px-10">
      ...
      <Link href="/login-register" className="hidden md:block px-6 py-2 bg-violet-500 rounded-full cursor-pointer transition duration-300 ease-in-out hover:bg-violet-700">Cuenta</Link>
