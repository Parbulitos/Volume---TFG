...
const SignIn = () => {
    return (
        <div className='top-0 left-0 w-1/2 h-full flex flex-col items-center justify-center p-10'>
            <h1 className='text-4xl font-bold text-black'>Iniciar sesión</h1>
            {/* Social Icons */}
            ...
            <span className='text-center text-lg mt-4 text-black'>o usa tu e-mail y contraseña para iniciar sesión</span>
